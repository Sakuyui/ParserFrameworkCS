...
namespace YaccLexCS.ycomplier.LrParser
{
    public class FormalLanguageParserTest
    {
        ...
        //                 var left = (int) obj[0];
        //                 var right = (int) obj[2];
        //                 return new CIExam.Complier.Token("S", TokenType.N, left + right + "");
        //             }
        //         },
        //         {
        //             "S->S-E", (obj) =>
        ...
        //                 var left = (int) obj[0];
        //                 var right = (int) obj[2];
        //                 return new CIExam.Complier.Token("E", TokenType.N, left * right + "");
        //             }
        //         },
        //         {
        //             "E->E/F", (obj) =>
        ...
        //             {
        //                 var op = (int) obj[0];
        //                 return new CIExam.Complier.Token("S", TokenType.N, op + "");
        //             }
        //         },
        //         {
        //             "E->F", (obj) =>
        //             {
        //                 var op = (int) obj[0];
        //                 return new CIExam.Complier.Token("E", TokenType.N, op + "");
        //             }
        //         },
        //         {
        //             "F->ID", (obj) =>
        //             {
        //                 var op = (int) obj[0];
        //                 return new CIExam.Complier.Token("F", TokenType.N, op + "");
        //             }
        //         },
        //     };
        //     p.Parse(reductions);
