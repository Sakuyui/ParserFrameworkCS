...
namespace YaccLexCS.code.structure
{
    ...
    public class DefinitionOrStatementNode : ASTNonTerminalNode
    {
        ...
        public DefinitionOrStatementNode(IEnumerable<ASTNode> child) : base(child, "definition_or_statement")
        {
        }
    }
}